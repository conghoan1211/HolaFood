 ...
 * @author hoang
 */
@WebServlet(name = "DeleteCateServlet", urlPatterns = {"/deletecategory"})
public class DeleteCateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean delete = ManagerCateDAO.gI().deleteCategory(cateId);
            if (delete) {
                request.getSession().setAttribute("msCate", "Xóa thành công");
            } else {
